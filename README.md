...
This form has three fields for the user to fill. The first one is the "Facility" which was chosen earlier. If the user eventually wants to select a different facility, there is the following dropdown menu:
...
<p align="center">
  <img width="2000" height="600" alt="image" src="https://github.com/user-attachments/assets/e066088a-e9e0-44d5-97c5-252d848ed4de" />
</p>
